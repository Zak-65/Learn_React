    ...
    return(
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <h1 className="text-2xl font-bold mb-4 ">
                Delicious Chocolate Cake {id}
            </h1>
            
            <img className="max-w-sm mx-auto my-4 rounded-lg shadow" src="https://images.unsplash.com/photo-1616031037011-087000171abe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxM3x8Q2hvY29sYXRlJTIwQ2FrZXxlbnwwfDB8fHwxNjk0MTc2ODk0fDA&ixlib=rb-4.0.3&q=80&w=1080" alt="Chocolate Cake" className="mb-4 rounded-lg shadow-md"/>
